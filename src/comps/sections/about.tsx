		...
		<section className='pt-40 overflow-hidden text-woodsmoke pb-80'>
			<Container>
				<Col colStart={[14]} colEnd={[25]}>
					...
					<p className='mt-40 mb-24 text-18'>Nous mettons un point d'honneur à ce qu'aucun obstacle ne vienne entraver l’acheminement des marchandises de nos clients.</p>
